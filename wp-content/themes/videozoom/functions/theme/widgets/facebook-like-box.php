...
?>
			...
			<div class="fb-like-box" data-colorscheme="<?php echo $color ?>" data-href="<?php echo $pageurl ?>" data-width="<?php echo $width ?>" data-show-faces="<?php echo $show_faces ?>" data-border-color="#<?php echo $bordercolor ?>" data-stream="<?php echo $show_stream ?>" data-header="<?php echo $show_header ?>"></div>
<?php
		...
		function form( $instance ) {
			...
			$defaults = array( 'title' => 'Like us on Facebook', 'pageurl' => 'http://www.facebook.com/wpzoom', 'width' => 225, 'bordercolor' => '333333', 'show_faces' => 'on', 'color' => 'dark', 'show_stream' => 'off', 'show_header' => 'off' );
			...
			<p>
				...
				<small>* Default: <strong>225</strong> </small>
			</p>
			<p>
				...
				<small>* Default: <strong>333333</strong> </small>
			</p>
